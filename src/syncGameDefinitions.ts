...
const nativeFinalDefinitions: readonly SyncGameDefinition[] = [
  { key: "count-up-game", title: "カウントアップゲーム", rule: "目標値、現在値、手番、履歴をサーバーが管理します。手番の人が1〜3を足し、目標値を超える入力は受け付けません。", examplePrompt: "30を目指そう", inputLabel: "足す数", inputPlaceholder: "1、2、3のいずれか", progression: "count-up" },
  { key: "dud-card-game", title: "ドキドキはずれカード", rule: "安全なカードをサーバーがシャッフルします。全員が内緒で1枚ずつ選び、全員の選択後にはずれを公開します。", examplePrompt: "カードを1枚選ぼう", inputLabel: "カード", inputPlaceholder: "カードを選択", progression: "simultaneous" },
  { key: "drinking-sugoroku", title: "飲み会すごろく", rule: "位置、手番、出目をサーバーが管理します。飲酒は不要で、水分補給、休憩、パスをいつでも選べます。", examplePrompt: "安全にゴールを目指そう", inputLabel: "サイコロ", inputPlaceholder: "サーバーが出目を決定", progression: "turn" },
  { key: "territory-game", title: "シンプル陣取り", rule: "盤面と手番をサーバーが管理します。空いているマスを順番に取り、終了時に獲得数を集計します。", examplePrompt: "空いているマスを取ろう", inputLabel: "マス", inputPlaceholder: "A1、B2、C3など", progression: "turn" },
  { key: "resource-negotiation-game", title: "資源交渉トーク", rule: "資源と交渉内容をサーバーが管理します。提案者と受取人だけが操作でき、成立した交換は同時に反映されます。", examplePrompt: "交渉して目標を達成しよう", inputLabel: "交換条件", inputPlaceholder: "token:1 / idea:1", progression: "simultaneous" },
  { key: "life-event-sugoroku", title: "人生イベントすごろく", rule: "位置、手番、安全な出目、イベントをサーバーが管理します。無理な参加は求めず、休憩やパスも選べます。", examplePrompt: "人生イベントを進もう", inputLabel: "サイコロ", inputPlaceholder: "サーバーが出目を決定", progression: "turn" },
  { key: "arm-wrestling-tournament", title: "腕相撲トーナメント", rule: "組み合わせと勝ち上がりをサーバーが管理し、審判が勝者を記録します。安全を最優先し、実際に力比べをしなくても遊べます。", examplePrompt: "安全第一のトーナメント", inputLabel: "勝者", inputPlaceholder: "審判が結果を記録", progression: "turn" },
  { key: "safe-random-draw", title: "安全はずれ抽選", rule: "安全な結果をサーバーがシャッフルし、選んだカードへ割り当てます。全員が選ぶまで結果は非公開です。", examplePrompt: "安全なカードを選ぼう", inputLabel: "カード", inputPlaceholder: "カードを選択", progression: "simultaneous" },
  { key: "large-majority-game", title: "大人数マジョリティ", rule: "全員が同時に内緒で投票します。全員の回答がそろうまで集計を隠し、その後に多数派と得点を表示します。", examplePrompt: "一番人気になる選択肢は？", inputLabel: "投票", inputPlaceholder: "選択肢を選ぶ", progression: "simultaneous" },
];
