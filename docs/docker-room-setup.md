...
- 人狼、ワードウルフ、二択トーク、マジョリティ系、第一印象ランキング、匿名質問箱、NGワードゲーム、ジョハリの窓、山手線ゲーム以外の各ゲーム内操作、カードめくり、回答入力はまだ端末ごとのローカル状態です。
...
1. 逆さ言葉 / 外来語禁止の手番・アウト・得点同期
2. お絵描き / 曲名 / 鼻歌 / 人物当ての親・回答・正解表示同期
3. すごろく / 陣取り / 資源交渉の盤面・コマ・資源同期
