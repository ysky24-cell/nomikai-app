...
- 人狼、ワードウルフ、二択トーク、マジョリティ系、第一印象ランキング、匿名質問箱、NGワードゲーム、ジョハリの窓、山手線ゲーム、逆さ言葉ゲーム、外来語禁止ゲーム、当てる系ゲーム、回答・集計系ゲーム、手番・抽選・対戦系ゲーム、盤面系ゲーム以外の各ゲーム内操作、カードめくり、回答入力はまだ端末ごとのローカル状態です。
...
1. ウミガメのスープの質問ログ、ヒント、真相表示同期
2. ひとこと演技ゲームの演者、感情選択、回答投票同期
