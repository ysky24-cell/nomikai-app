...
- 人狼、ワードウルフ、二択トーク、マジョリティ系、第一印象ランキング、匿名質問箱、NGワードゲーム、ジョハリの窓、山手線ゲーム、逆さ言葉ゲーム、外来語禁止ゲーム、当てる系ゲーム、盤面系ゲーム以外の各ゲーム内操作、カードめくり、回答入力はまだ端末ごとのローカル状態です。
...
1. 2つの真実と1つの嘘 / 価値観メーター / スマホ早打ちの回答・集計同期
2. 抽選 / はずれカード / 腕相撲トーナメントの山札・勝敗同期
