...
- 人狼、ワードウルフ、二択トーク、マジョリティ系、第一印象ランキング、匿名質問箱、NGワードゲーム、ウミガメのスープ、ジョハリの窓、山手線ゲーム、逆さ言葉ゲーム、外来語禁止ゲーム、当てる系ゲーム、回答・集計系ゲーム、ひとこと演技ゲーム、手番・抽選・対戦系ゲーム、盤面系ゲーム以外の各ゲーム内操作、カードめくり、回答入力はまだ端末ごとのローカル状態です。
